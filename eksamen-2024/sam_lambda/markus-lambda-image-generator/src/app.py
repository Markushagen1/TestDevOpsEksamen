...
candidateNumber = os.getenv("CANDIDATE_NUMBER", "36")
...
def lambda_handler(event, context):
    ...
    s3_image_path = f"{candidateNumber}/generated_images/titan_{seed}.png"
    ...
    try:
        ...
        return {
            "statusCode": 200,
            "body": json.dumps({"message": "The image was generated successfully", "s3_path": f"s3://{bucket_name}/{s3_image_path}"})
        }
        ...
        return {
            "statusCode": 500,
            "body": json.dumps({"message": "The image generation failed", "error": str(e)})
        }
